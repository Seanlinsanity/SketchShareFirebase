...
public func clamp(value: Vec2, min: Float, max: Float) -> Vec2 {return Vec2(clamp(value:value.x, min: min, max: max), clamp(value: value.y, min: min, max: max))}
public func mix(a: Vec2, b: Vec2, t: Float) -> Vec2 {return a + (b - a) * t}
public func smoothstep(a: Vec2, b: Vec2, t: Float) -> Vec2 {return mix(a:a, b: b, t: t * t * (3 - 2 * t))}

public func clamp(value: Vec2, min: Vec2, max: Vec2) -> Vec2 {return Vec2(clamp(value:value.x, min: min.x, max: max.x), clamp(value:value.y, min: min.y, max: max.y))}
public func mix(a: Vec2, b: Vec2, t: Vec2) -> Vec2 {return a + (b - a) * t}
public func smoothstep(a: Vec2, b: Vec2, t: Vec2) -> Vec2 {return mix(a:a, b: b, t: t * t * (Vec2(s: 3) - 2 * t))}
